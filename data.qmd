...
- method-unknown: the percentage of people whose voting method is unknown.
...
ggplot(data = combined_data, aes(x = year)) +
  ...
  geom_line(aes(y = goal_rate, color = "Goal Rate")) +
  labs(title = "Voting Rates Over Time", x = "Year", y = "Vote Rate (%)", color = "Legend") +
  scale_x_continuous(
...
ggplot(voting_method_long, aes(x = factor(year), y = vote_rate, fill = voting_method)) +
  ...
  labs(title = "Voting Methods Over Time",
       x = "Election Year", y = "Voting Rate (%)", fill = "Voting Method") +  # Labels
